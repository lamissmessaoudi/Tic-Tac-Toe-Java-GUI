...
public class TicTacToeGui extends JFrame {
	...
	private void hasWinner() {
		if (board[0][0].getText().equals(currentPlayer) && board[0][1].getText().equals(currentPlayer)
			...
			JOptionPane.showMessageDialog(null, "player " + currentPlayer + " has won this round");
			hasWinner = true;
			...
			JOptionPane.showMessageDialog(null, "player " + currentPlayer + " has won this round");
			hasWinner = true;
		} else if (board[0][0].getText().equals(currentPlayer) && board[1][0].getText().equals(currentPlayer)
